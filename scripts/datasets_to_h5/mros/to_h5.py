...
if __name__ == "__main__":
    ...
    from scripts.settings import MROS_SETTINGS
    from joblib import Parallel, delayed

    records_directory, annotations_directory, h5_directory = (
        MROS_SETTINGS["records_directory"],
        MROS_SETTINGS["annotations_directory"],
        MROS_SETTINGS["h5_directory"],
    )
