...
from ..logger.logger import log_experiment
        ...
        for memmap_description in memmaps_description:
            ...
            if dataset in datasets:
                ...
                for dataset_parameter in dataset_parameters:
                    ...
                    h5_to_memmaps(
                        records=[
                            dataset_setting["h5_directory"] + record
                            for record in os.listdir(dataset_setting["h5_directory"])
                        ],
                    ...
                    for i, fold in enumerate(folds):
                        ...
                        if i in fold_to_run:
                            ...
                            log_experiment(
                                **experiment_description, parralel=True, generate_memmaps=False,
                            )
