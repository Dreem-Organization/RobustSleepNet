...
if __name__ == "__main__":
    ...
    from scripts.settings import MESA_SETTINGS
    from joblib import Parallel, delayed

    records_directory, annotations_directory, h5_directory = (
        MESA_SETTINGS["records_directory"],
        MESA_SETTINGS["annotations_directory"],
        MESA_SETTINGS["h5_directory"],
    )
